...
public class FacebookAuthenticationParser extends AsyncTask<String, String, User> {
    ...
    public FacebookAuthenticationParser(Activity activity, AuthenticationUserResultReceived listener) {
    ...
    protected User doInBackground(String... params) {
        UserAuthenticationRequest userAuthenticationRequest = new UserAuthenticationRequest(params[0], params[1], params[2], params[3]);
