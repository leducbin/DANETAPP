...
/**
 * Provides circle page indicator view. Add this to the layout and attach instance of this to {@link ViewPager} in onCreate method.
 */
public class CircleIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private int mAnimatorResId = R.anim.anim_scale_with_alpha;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin, R.anim.anim_scale_with_alpha, 0, R.drawable.white_radius, R.drawable.white_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.anim.anim_scale_with_alpha : mAnimatorResId;
    ...
    public void onPageSelected(int position) {
        ...
        if (position != 0) // Customized to support Circular View Pager.
            position = Utils.getRealPosition(position, mViewpager.getAdapter().getCount());
    ...
    private void createIndicators(ViewPager viewPager) {
        ...
        for (int i = 1; i < count - 2; i++) {// Customized to support Circular View Pager. Added Count - 2
